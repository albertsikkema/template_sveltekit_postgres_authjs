...
export const createTicket = async (
  title, description, created_by, images
) => {
  try {
...
export const updateTicket = async (
  id, title, description, created_by, assigned_to, status, images
) => {
  try {
    console.log('===> updateTicket', { id, title, description, created_by, assigned_to, status, images });
